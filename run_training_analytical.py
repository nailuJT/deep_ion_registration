...
for patient in patients:
    ...
    # else:
    train_slices += [np.load(r'/project/med2/Ines.Butz/Data/ML/PrimalDual/20231011_analytical_'+patient+'_1mm3mm1mm_train_slices.npy')]
    val_slices += [np.load(r'/project/med2/Ines.Butz/Data/ML/PrimalDual/20231011_analytical_'+patient+'_1mm3mm1mm_val_slices.npy')]
